        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
            <div className="pt-6 md:pt-10">
                ...
                <div className="max-w-3xl mx-auto  pb-12 md:pb-16">
                    ...
                    <h3 className="mb-4 ">TRUSTON was established in 2017 as a partnership firm to serve quality Polymers & customized products to boost the thrust of engineering growth. Three decades of experience & technical expertise in the Polymer processing industry helps us to identify perfect material combination for each application.</h3>
                    <h4 className="mb-4 text-gray-600">Truston committed to provide the best service and the best products to our customers.</h4>
                    <h4 className="mb-4 text-gray-600">The high-performing Engineering Plastics are used in numerous industrial applications including,</h4>
                ...
                <div className="max-w-3xl mx-auto  pb-12 md:pb-16">
                    <h1 className="h2 text-center mb-4">Benefits of Engineering Plastics</h1>
